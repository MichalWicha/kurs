    ...
    //wyświetlanie plików
             ...
             echo "<ul>";
                foreach ($pliki as $wartosc){
                    echo "<li>$wartosc <a href=\"4_tworzeniePlikow.php?usunP=$wartosc\">Usuń</a></li>";
                }
             echo "</ul><hr>";
    ...
    //wyświetlanie katalogów
             ...
             echo "<ul>";
                foreach ($katalogi as $wartosc){
                    echo "<li>$wartosc <a href=\"4_tworzeniePlikow.php?usunK=$wartosc\">Usuń</a></li>";
                }
             echo "</ul><hr>";
        }
    ?>
    <a href="4_tworzeniePlikow.php?sortuj=0">Sortuj rosnąco</a>
    <a href="4_tworzeniePlikow.php?sortuj=1">Sortuj malejąco</a>
</body>
</html>
